...
int main()
{
    ...
    do
    {
        ...
        tela_inicial();
        gotoxy(POS_CAIXA_X + 20, POS_CAIXA_Y + 7);
        printf("h- Ajuda");
...
void tela_de_ajuda()
{
    ...
    gotoxy(POS_CAIXA_X + 2, POS_CAIXA_Y + 1);
    printf("w- CIMA");
    gotoxy(POS_CAIXA_X + 2, POS_CAIXA_Y + 2);
    printf("s- BAIXO");
    gotoxy(POS_CAIXA_X + 2, POS_CAIXA_Y + 3);
    printf("a- ESQUERDA");
    gotoxy(POS_CAIXA_X + 2, POS_CAIXA_Y + 4);
    printf("d- DIREITA");
    gotoxy(POS_CAIXA_X + 2, POS_CAIXA_Y + 5);
    printf("f- ENTRAR");
    gotoxy(POS_CAIXA_X + 20, POS_CAIXA_Y + 7);
    printf("h- Voltar");
    char opcao;
