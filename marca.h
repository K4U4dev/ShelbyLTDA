...
void logo_bicho(int x, int y)
{
    ...
    printf("   |    | |    | |    | |    |  |    | |    |  |    \\ | |   _  |   | |    |");
    gotoxy(x, y++);
    printf("___|____|_|____|_|____|_|____|__|___/__|____|__|____/_|_|____|_|   |_|____|___");
}

void logo_origem(int x, int y)
{
    gotoxy(x, y++);
    printf("______________________________________________________________________________");
    gotoxy(x, y++);
    ...
    printf("                |    |  |    | |   \\  | |    | |      |  \\/  |");
    gotoxy(x, y++);
    printf("________________|    |__|____|_|    |_|_|____|_|____|_|      |________________");
}

void logo_cotacao(int x, int y)
{
    gotoxy(x, y++);
